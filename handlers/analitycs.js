...
module.exports = async (controller) => {
  controller.on(['ANALYTICS_EVENT'], async (bot, message) => {
     ...
     * @TODO Fix that
     */
    // if (process.env.NODE_ENV !== 'production' && message.value !== undefined) {
    //   /**
    ...
    //   console.log('[ANALYTICS_EVENT]:', /*!!message.value ? message.value : message.type, */message.value, message.type);
    //   // const options = {
