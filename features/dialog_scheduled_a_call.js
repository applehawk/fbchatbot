...
module.exports = async (controller) => {
  ...
  const dialog = controller.dialogSet.dialogs[DIALOG_SCHEDULED_A_CALL_ID];
      ...
      },
      {
        ...
        handler: async (response, convo, bot, message) => {
          if (
            ...
            await controller.trigger(['repeat_match'], bot, message);
            await bot.say({
  ...
  await dialog.after(async (results, bot) => {
    try {
      ...
      console.error('[scheduled_a_call.js:122 ERROR]:', error);
    }
  });
